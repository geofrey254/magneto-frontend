  ...
  return (
    <section className="">
      <form action="" className="">
        ...
        <a
          href="javascript:;"
          className="text-[#350203] text-base font-medium leading-6"
        >
          Forgot password?
        </a>
        <div className="flex mt-7 mb-5">
          <button className="w-full h-12 bg-[#350203] hover:bg-[#3502038f] transition-all duration-700 rounded-full shadow-xs text-white text-base font-semibold leading-6">
            LOGIN
          </button>
        </div>
        ...
        <div className="flex items-center justify-center gap-x-3">
          <a
            href="javascript:;"
            className="relative w-9 h-9 rounded-full transition-all duration-500 flex justify-center items-center bg-gray-700  hover:bg-indigo-600"
          >
            <svg
